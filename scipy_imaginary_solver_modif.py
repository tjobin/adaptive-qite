...
# I, Timothé Jobin, have modified this file.
...
from qiskit_algorithms.time_evolvers.imaginary_time_evolver import ImaginaryTimeEvolver
from time_evolution import _evolve
...
class SciPyImaginaryEvolver(ImaginaryTimeEvolver):
    ...
    def evolve(self, evolution_problem: TimeEvolutionProblem, times, filename=None) -> TimeEvolutionResult:
        ...
        """
        return _evolve(evolution_problem, self.num_timesteps, real_time=False, params=times, filename=filename)
